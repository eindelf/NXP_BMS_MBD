...
extern void PIT_Ch1_ISR(void);
extern void PIT_Ch2_ISR(void);
extern void PIT_Ch3_ISR(void);
...
uint32_t ISRVectorTable[] = {
  ...
  (uint32_t)&PIT_Ch1_ISR,              /* ISR 60 */
  (uint32_t)&PIT_Ch2_ISR,              /* ISR 61 */
