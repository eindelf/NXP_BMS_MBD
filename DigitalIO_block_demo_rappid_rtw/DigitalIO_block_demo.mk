...
MODEL           = DigitalIO_block_demo
MODULES         = gpio_564xl_library.c gt_pf.c intc_init.c intc_sw_vectable.c pit_ch1_isr.c pit_ch2_isr.c pit_ch3_isr.c pit_timer_564xl_library.c profile_buffer.c rappid_main.c rappid_utils.c siu_init.c sys_init.c sysclk_init.c 
MAKEFILE        = DigitalIO_block_demo.mk
...
MODELLIB                  = DigitalIO_block_demolib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	...
	-IC:\MCToolbox\rappid564xl\DigitalIO_block_demo_rappid_rtw \
