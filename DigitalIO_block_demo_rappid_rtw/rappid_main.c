...
{
  /* Initialize model */
  DigitalIO_block_demo_initialize();
}

void SYSTEM_TASK(void)
{
  DigitalIO_block_demo_step();
...
void pit_init_fnc(void)
{
  ...
  //    PIT.CH[1].LDVAL.R  =  0x005B8D7F;    /* The model's base sample time is 0.05 seconds. */
  ...
  /* ----------------------------------------------------------- */
  PIT.CH[0].LDVAL.R = 0x005B8D7F;      /* The model's base sample time is 0.05 seconds. */
