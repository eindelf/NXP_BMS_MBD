...
#include "can_simple_block1130_private.h"

/* Block signals (auto storage) */
BlockIO_can_simple_block1130 can_simple_block1130_B;

/* External outputs (root outports fed by signals with auto storage) */
ExternalOutputs_can_simple_bloc can_simple_block1130_Y;

/* Output and update for function-call system: '<Root>/Subsystem' */
void can_simple_block1130_Subsystem(void)
{
  int32_T i;

  /* Inport: '<S1>/In3' */
  for (i = 0; i < 8; i++) {
    can_simple_block1130_B.In3[i] =
      can_simple_block1130_B.CANReceiveDataTrigger1_o4[i];
  }
...
/* Model step function */
void can_simple_block1130_step(void)
{
  /* S-Function (can_564xl_receive_data): '<Root>/CAN_Receive_data1' */
  {
    ...
    if (flexcan_564xl_rxbuffull( 0, 7)) {
      can_simple_block1130_Y.Out3 = flexcan_564xl_get_id(0, 7);
      flexcan_564xl_get_mb(ptr_FLEXCAN_MsgBufferStructure, 0, 7);
      for (i=0;i<ptr_FLEXCAN_MsgBufferStructure->length;i++) {
        (&can_simple_block1130_Y.Out1[0])[i] =
          ptr_FLEXCAN_MsgBufferStructure->data[i];
      }

      can_simple_block1130_Y.Out2 = flexcan_564xl_get_idtype(0, 7);
      can_simple_block1130_Y.Out4 = flexcan_564xl_get_ts(0, 7);
  ...
  /* Outport: '<Root>/Out5' */
  can_simple_block1130_Y.Out5 = can_simple_block1130_B.In3[0];
   ...
   */
  can_simple_block1130_B.TmpSignalConversionAtCANTransmi[0] = 1U;
  can_simple_block1130_B.TmpSignalConversionAtCANTransmi[1] = 2U;
  can_simple_block1130_B.TmpSignalConversionAtCANTransmi[2] = 3U;
  can_simple_block1130_B.TmpSignalConversionAtCANTransmi[3] = 4U;
  can_simple_block1130_B.TmpSignalConversionAtCANTransmi[4] = 5U;
  can_simple_block1130_B.TmpSignalConversionAtCANTransmi[5] = 6U;
  can_simple_block1130_B.TmpSignalConversionAtCANTransmi[6] = 7U;
  can_simple_block1130_B.TmpSignalConversionAtCANTransmi[7] = 8U;
  ...
  /* S-Function (can_564xl_transmit): '<Root>/CAN Transmit1' */
  {
    ...
    FLEXCAN_MsgBufferStructure str_FLEXCAN_MsgBufferStructure;
    uint8_t i = 0U;
    uint8_t* data = &can_simple_block1130_B.TmpSignalConversionAtCANTransmi[0];
    ...
    ptr_FLEXCAN_MsgBufferStructure->id = 1020;
    for (i=0;i<datalen;i++) {
...
void can_simple_block1130_initialize(void)
{
  /* Registration code */

  /* block I/O */
  (void) memset(((void *) &can_simple_block1130_B), 0,
                sizeof(BlockIO_can_simple_block1130));

  /* external outputs */
  (void) memset((void *)&can_simple_block1130_Y, 0,
...
void can_simple_block1130_terminate(void)
{
