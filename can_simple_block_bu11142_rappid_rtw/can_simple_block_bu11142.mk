...
MODEL           = can_simple_block_bu11142
MODULES         = adc0_config.c adc_564xl_library.c adc_init.c adc_trigger_init.c can0_buf4_7_isr.c dspi1_2_isr.c dspi_564xL_library.c flexcan_564xl_library.c gpio_564xl_library.c intc_init.c intc_sw_vectable.c pit_ch1_isr.c pit_timer_564xl_library.c rappid_main.c rappid_utils.c siu_init.c sys_init.c sysclk_init.c 
MAKEFILE        = can_simple_block_bu11142.mk
ALT_MATLAB_ROOT = C:\PROGRA~1\MATLAB\R2016b
MATLAB_ROOT     = C:\Program Files\MATLAB\R2016b
S_FUNCTIONS     = DMA_init_wrapper.c DMA.c rt_roundd_snf.c rtGetInf.c SOCEstimationInit_wrapper.c rt_nonfinite.c Extended.c look2_binlx.c rtGetNaN.c const_params.c SPIRead_wrapper.c BMU_Driver.c SPITask_wrapper.c
S_FUNCTIONS_OBJ = DMA_init_wrapper.obj DMA.obj rt_roundd_snf.obj rtGetInf.obj SOCEstimationInit_wrapper.obj rt_nonfinite.obj Extended.obj look2_binlx.obj rtGetNaN.obj const_params.obj SPIRead_wrapper.obj BMU_Driver.obj SPITask_wrapper.obj
S_FUNCTIONS_LIB = 
SOLVER          = 
NUMST           = 2
TID01EQ         = 0
...
MODELLIB                  = can_simple_block_bu11142lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	...
	-IC:\MCToolbox\rappid564xl\can_simple_block_bu11142_rappid_rtw \
	-IC:\MCToolbox\rappid564xl \
	-IC:\MCToolbox\rappid564xl\Examples \
	-IC:\MCToolbox\rappid564xl\src\sfmInclude \
	-IC:\MCToolbox\rappid564xl\src\includes \
	-IC:\MCToolbox\rappid564xl\src\OptInclude \
...
$(LIB_TEMP)/%.o: C:\MCToolbox\rappid564xl\Examples/%.c
	@echo ### "C:\MCToolbox\rappid564xl\Examples\$*.c"
	@$(COMPILE_TOOL) $(COMPILE_TOOL_OPTS) $(CFLAGS) -o $@ -c $<
$(PLIB_TEMP)/%.o: C:\MCToolbox\rappid564xl\Examples/%.c
	@echo ### "C:\MCToolbox\rappid564xl\Examples\$*.c"
	@$(COMPILE_TOOL) $(COMPILE_TOOL_OPTS) $(CFLAGS) -o $@ -c $<


$(LIB_TEMP)/%.o: C:\MCToolbox\rappid564xl\src\sfmSrc/%.c
	@echo ### "C:\MCToolbox\rappid564xl\src\sfmSrc\$*.c"
	@$(COMPILE_TOOL) $(COMPILE_TOOL_OPTS) $(CFLAGS) -o $@ -c $<
$(PLIB_TEMP)/%.o: C:\MCToolbox\rappid564xl\src\sfmSrc/%.c
	@echo ### "C:\MCToolbox\rappid564xl\src\sfmSrc\$*.c"
	@$(COMPILE_TOOL) $(COMPILE_TOOL_OPTS) $(CFLAGS) -o $@ -c $<


$(LIB_TEMP)/%.o: C:\MCToolbox\rappid564xl\src\c_library/%.c
	@echo ### "C:\MCToolbox\rappid564xl\src\c_library\$*.c"
	@$(COMPILE_TOOL) $(COMPILE_TOOL_OPTS) $(CFLAGS) -o $@ -c $<
$(PLIB_TEMP)/%.o: C:\MCToolbox\rappid564xl\src\c_library/%.c
	@echo ### "C:\MCToolbox\rappid564xl\src\c_library\$*.c"
	@$(COMPILE_TOOL) $(COMPILE_TOOL_OPTS) $(CFLAGS) -o $@ -c $<


$(LIB_TEMP)/%.o: C:\MCToolbox\rappid564xl\src\OptSrc/%.c
	@echo ### "C:\MCToolbox\rappid564xl\src\OptSrc\$*.c"
	@$(COMPILE_TOOL) $(COMPILE_TOOL_OPTS) $(CFLAGS) -o $@ -c $<
$(PLIB_TEMP)/%.o: C:\MCToolbox\rappid564xl\src\OptSrc/%.c
	@echo ### "C:\MCToolbox\rappid564xl\src\OptSrc\$*.c"
	@$(COMPILE_TOOL) $(COMPILE_TOOL_OPTS) $(CFLAGS) -o $@ -c $<
