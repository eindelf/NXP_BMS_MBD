 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Tue Jan  2 13:04:49 2018
*/
...
extern void SOCEstimationTask_Outputs_wrapper(const real_T *I,
			const real_T *V8,
			const real_T *T,
...
{
    const real_T   *I  = (const real_T*) ssGetInputPortSignal(S,0);
    const real_T   *V8  = (const real_T*) ssGetInputPortSignal(S,1);
    const real_T   *T  = (const real_T*) ssGetInputPortSignal(S,2);
    const boolean_T   *Enable8  = (const boolean_T*) ssGetInputPortSignal(S,3);
    real_T        *SOC  = (real_T *)ssGetOutputPortRealSignal(S,0);
    real_T        *Vt  = (real_T *)ssGetOutputPortRealSignal(S,1);
