...
%
blkStruct.Name = ['Motor Control Library' sprintf('\n')];

%
% The function that will be called when the user double-clicks on
% this icon.
%
blkStruct.OpenFcn = 'BAMLIB564xL';
...
%
Browser(1).Library = 'BAMLIB564xL';
Browser(1).Name    = 'Freescale Application Motor Control Library Blocks for MPC564xL';
...
% and Toolboxes subsystem.
%
blkStruct.Name = ['FMC Library' sprintf('\n')];
