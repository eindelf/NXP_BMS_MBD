...
typedef struct {
  const uint16_T DataTypeConversion4;  /* '<Root>/Data Type Conversion4' */
} ConstBlockIO_can_spi_simple_blo;
...
extern const ConstBlockIO_can_spi_simple_blo can_spi_simple_block_bu_ConstB;/* constant block i/o */
