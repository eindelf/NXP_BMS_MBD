...
extern void dspi1_isr(void);
extern void dspi0_2_isr(void);
extern void dspi0_4_isr(void);
...
uint32_t ISRVectorTable[] = {
  ...
  (uint32_t)&dspi0_2_isr,              /* ISR 75 */
  (uint32_t)&interrupt_handler,        /* ISR 76 */
  (uint32_t)&dspi0_4_isr,              /* ISR 77 */
