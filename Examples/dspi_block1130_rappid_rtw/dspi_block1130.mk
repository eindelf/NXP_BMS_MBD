...
MODEL           = dspi_block1130
MODULES         = BMU_Driver.c SPITask.c SPITask_wrapper.c dspi0_2_isr.c dspi0_4_isr.c dspi1_EOC_isr.c dspi_564xL_library.c freemaster_MPC56xx.c freemaster_appcmd.c freemaster_protocol.c freemaster_rec.c freemaster_scope.c freemaster_serial.c freemaster_sfio.c freemaster_tsa.c gpio_564xl_library.c intc_init.c intc_sw_vectable.c linflex_init.c linflex_siu_init.c rappid_main.c rappid_utils.c siu_init.c sys_init.c sysclk_init.c 
MAKEFILE        = dspi_block1130.mk
...
MODELLIB                  = dspi_block1130lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	...
	-IC:\MCToolbox\rappid564xl\Examples\dspi_block1130_rappid_rtw \
