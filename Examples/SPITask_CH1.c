 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Tue Jan  9 17:13:13 2018
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME SPITask_CH1
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void SPITask_CH1_Outputs_wrapper(const uint8_T *CMD32,
			uint8_T *y0,
			uint8_T *PecChk);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    SPITask_CH1_Outputs_wrapper(CMD32, y0, PecChk);
