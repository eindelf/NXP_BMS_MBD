...
MODEL           = can_simple_block_bu11143
MODULES         = BMU_Driver.c DMA.c DMA_init.c DMA_init_wrapper.c Extended.c SOCEstimationInit.c SOCEstimationInit_wrapper.c SOCEstimationTask.c SOCEstimationTask_wrapper.c SPIRead.c SPIRead_wrapper.c SPISendDMA.c SPISendDMA_wrapper.c SPITask.c SPITask_CH1_wrapper.c SPITask_wrapper.c adc0_config.c adc_564xl_library.c adc_init.c adc_trigger_init.c can0_buf4_7_isr.c can_simple_block_bu11143_data.c const_params.c dspi1_2_isr.c dspi_564xL_library.c flexcan_564xl_library.c gpio_564xl_library.c intc_init.c intc_sw_vectable.c look2_binlx.c pit_ch1_isr.c pit_ch2_isr.c pit_timer_564xl_library.c rappid_main.c rappid_utils.c romcopy.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_roundd_snf.c siu_init.c sys_init.c sysclk_init.c 
MAKEFILE        = can_simple_block_bu11143.mk
...
MODELLIB                  = can_simple_block_bu11143lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	...
	-IC:\MCToolbox\rappid564xl\Examples\can_simple_block_bu11143_rappid_rtw \
