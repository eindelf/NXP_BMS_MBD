 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Thu Dec 28 16:21:21 2017
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME PEC15for6bytes
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void PEC15for6bytes_Outputs_wrapper(const uint8_T *data,
			const uint8_T *len,
			uint16_T *y0);
...
{
    const uint8_T   *data  = (const uint8_T*) ssGetInputPortSignal(S,0);
    const uint8_T   *len  = (const uint8_T*) ssGetInputPortSignal(S,1);
    uint16_T        *y0  = (uint16_T *)ssGetOutputPortRealSignal(S,0);

    PEC15for6bytes_Outputs_wrapper(data, len, y0);
