...
void dspi_block_Subsystem1(void)
{
  ...
  gpo_pin_update_564xl_fnc(12, dspi_block_B.sf_Chart.A);/* GPO Pin Data Output Register Update */
}
...
void dspi_block_Subsystem2(void)
{
  ...
  gpo_pin_update_564xl_fnc(48, dspi_block_B.sf_Chart_c.A);/* GPO Pin Data Output Register Update */
}
...
void dspi_block_Subsystem_Start(void)
{
  ...
  /* Initialize Pad Configuration Register 79 as Output */
  gpo_init_pcr_out_564xl_fnc( 79 );
}
...
void dspi_block_Subsystem(void)
{
  ...
  /* Pin Data Output Signal Update PCR[79]. */
  gpo_pin_update_564xl_fnc(79, dspi_block_B.sf_Chart_h.A);/* GPO Pin Data Output Register Update */
}
