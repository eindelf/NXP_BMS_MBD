...
{
  /* Initialize model */
  can_simple_block_bu11142_initialize();
}
...
void SYSTEM_TASK(void)
{
   ...
   */
  can_simple_block_bu11142_SetEventsForThisBaseStep(eventFlags);

  /* Set model inputs associated with base rate here */
  can_simple_block_bu11142_step(0);

  /* Get model outputs here */
  if (eventFlags[1]) {
    /* Set model inputs associated with subrates here */
    can_simple_block_bu11142_step(1);
