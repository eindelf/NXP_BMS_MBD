...
/* Named constants for Chart: '<S23>/Chart1' */
...
#define IN_DMA_Running                 ((uint8_T)1U)
#define IN_InitDMA                     ((uint8_T)2U)
...
extern void can_simple_block_bu11142_step0(void);
extern void can_simple_block_bu11142_step1(void);
...
{
  /* SystemReset for Chart: '<S23>/Chart1' */
...
void Subsystem_i(rtDW_Subsystem *localDW, uint16_T rtd_CellV_1_104[104])
{
  ...
  /* End of Chart: '<S23>/Chart1' */

  /* MATLAB Function: '<S23>/RawData to StoreData' */
  /* MATLAB Function 'Function-Call Subsystem/Subsystem/RawData to StoreData': '<S29>:1' */
  /* '<S29>:1:4' VTDataCAN_8b =  uint8(zeros(1,8)); */
  for (i = 0; i < 8; i++) {
    localDW->VTDataCAN_8b[i] = 0U;
  }

  /* '<S29>:1:6' VTDataCAN_8b(1) =         CellV_1_104(StrCell*4-3)/256; */
  i = (int32_T)rt_roundd_snf((real_T)rtd_CellV_1_104[(int32_T)(localDW->count *
    4.0 - 3.0) - 1] / 256.0);
  tmp = (uint16_T)i;
  if ((uint16_T)i > 255) {
    tmp = 255U;
  ...
  /* '<S29>:1:7' VTDataCAN_8b(2) = mod(CellV_1_104(StrCell*4-3),256); */
  ...
  /* '<S29>:1:8' VTDataCAN_8b(3) =         CellV_1_104(StrCell*4-2)/256; */
  i = (int32_T)rt_roundd_snf((real_T)rtd_CellV_1_104[(int32_T)(localDW->count *
    4.0 - 2.0) - 1] / 256.0);
  tmp = (uint16_T)i;
  if ((uint16_T)i > 255) {
  ...
  /* '<S29>:1:9' VTDataCAN_8b(4) = mod(CellV_1_104(StrCell*4-2),256); */
  tmp = (uint16_T)((uint32_T)rtd_CellV_1_104[(int32_T)(localDW->count * 4.0 -
  ...
  /* '<S29>:1:10' VTDataCAN_8b(5) =         CellV_1_104(StrCell*4-1)/256; */
  i = (int32_T)rt_roundd_snf((real_T)rtd_CellV_1_104[(int32_T)(localDW->count *
    4.0 - 1.0) - 1] / 256.0);
  tmp = (uint16_T)i;
  if ((uint16_T)i > 255) {
  ...
  /* '<S29>:1:11' VTDataCAN_8b(6) = mod(CellV_1_104(StrCell*4-1),256); */
  tmp = (uint16_T)((uint32_T)rtd_CellV_1_104[(int32_T)(localDW->count * 4.0 -
  ...
  /* '<S29>:1:12' VTDataCAN_8b(7) =         CellV_1_104(StrCell*4   )/256; */
  i = (int32_T)rt_roundd_snf((real_T)rtd_CellV_1_104[(int32_T)(localDW->count *
    4.0) - 1] / 256.0);
  tmp = (uint16_T)i;
  if ((uint16_T)i > 255) {
  ...
  /* '<S29>:1:13' VTDataCAN_8b(8) = mod(CellV_1_104(StrCell*4   ),256); */
  ...
  /* End of MATLAB Function: '<S23>/RawData to StoreData' */
  ...
  /* S-Function (can_564xl_transmit): '<S23>/CAN Transmit1' */
  {
...
/* Output and update for function-call system: '<S2>/DMA_Init' */
void DMA_Init(void)
{
  /* S-Function (DMA_init): '<S15>/S-Function Builder' */
...
void FunctionCallSubsystem_Reset(void)
{
  ...
  /* SystemReset for Chart: '<S2>/Chart3' */
  rtDWork.is_active_c22_can_simple_block_ = 0U;
  rtDWork.is_c22_can_simple_block_bu11142 = IN_NO_ACTIVE_CHILD_j;
...
void FunctionCallSubsystem(void)
{
  ...
  /* During: Function-Call
     Subsystem/Chart3 */
  if (rtDWork.is_active_c22_can_simple_block_ == 0U) {
    /* Entry: Function-Call
       Subsystem/Chart3 */
    rtDWork.is_active_c22_can_simple_block_ = 1U;

    /* Entry Internal: Function-Call
       Subsystem/Chart3 */
    /* Transition: '<S13>:1' */
    rtDWork.is_c22_can_simple_block_bu11142 = IN_InitDMA;

    /* Outputs for Function Call SubSystem: '<S2>/DMA_Init' */

    /* Entry 'InitDMA': '<S13>:3' */
    /* Event: '<S13>:15' */
    DMA_Init();

    /* End of Outputs for SubSystem: '<S2>/DMA_Init' */
  } else if (rtDWork.is_c22_can_simple_block_bu11142 != IN_DMA_Running) {
    /* During 'InitDMA': '<S13>:3' */
    /* Transition: '<S13>:7' */
    rtDWork.is_c22_can_simple_block_bu11142 = IN_DMA_Running;

    /* Entry 'DMA_Running': '<S13>:6' */
  } else {
    /* During 'DMA_Running': '<S13>:6' */
  }
  ...
  if (rtDWork.is_active_c15_can_simple_block_ == 0U) {
    ...
    switch (rtDWork.is_c15_can_simple_block_bu11142) {
     ...
     case IN_GPIO45_Vref:
      /* During 'GPIO45_Vref': '<S16>:13' */
      /* Transition: '<S16>:16' */
      rtDWork.count++;

      /* Exit 'GPIO45_Vref': '<S16>:13' */
      /* Event: '<S16>:27' */
      rtDWork.is_c15_can_simple_block_bu11142 = IN_Vol_C123;
     ...
     default:
      /* During 'Vol_C789': '<S16>:11' */
      /* Transition: '<S16>:14' */
      /* Exit 'Vol_C789': '<S16>:11' */
      /* Event: '<S16>:29' */
      rtDWork.is_c15_can_simple_block_bu11142 = IN_GPIO123;

      /* Entry 'GPIO123': '<S16>:12' */
      rtDWork.CMD32[0] = (uint8_T)0x04;
      rtDWork.CMD32[1] = (uint8_T)0x60;
      rtDWork.CMD32[2] = (uint8_T)0x00;
  ...
  /* MATLAB Function 'Function-Call Subsystem/RawData to StoreData': '<S20>:1' */
  /* '<S20>:1:4' DataFault =  zeros(1,7); */
  /* '<S20>:1:6' switch STATE */
  switch (rtb_STATE) {
   case 0:
    /* '<S20>:1:7' case 0 % VC123 */
    /*  VC123 */
    /* '<S20>:1:8' for i=1:7 */
    for (rtb_STATE = 0; rtb_STATE < 7; rtb_STATE++) {
      /* '<S20>:1:9' CellV_1_104(i*8-7) = uint16(SPIData(i*8-7))*256+uint16(SPIData(i*8-6)); */
      ...
      /* '<S20>:1:10' CellV_1_104(i*8-6) = uint16(SPIData(i*8-5))*256+uint16(SPIData(i*8-4)); */
      ...
      /* '<S20>:1:11' CellV_1_104(i*8-5) = uint16(SPIData(i*8-3))*256+uint16(SPIData(i*8-2)); */
      ...
      /* '<S20>:1:12' if (PecChk(i*2-1) == SPIData(i*8-1)) && (PecChk(i*2) == SPIData(i*8)) */
    }
    break;

   case 1:
    /* '<S20>:1:18' case 1 % VC456 */
    /*  VC456 */
    break;

   case 2:
    /* '<S20>:1:20' case 2 % VC78 */
    /*  VC78 */
    break;

   case 3:
    /* '<S20>:1:22' case 3 % GP123 */
    /*  GP123 */
    break;

   case 4:
    /* '<S20>:1:24' case 4 % GP45 */
    /*  GP45 */
    break;
