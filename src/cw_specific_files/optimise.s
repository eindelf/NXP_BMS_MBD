...
#**************************************************************************/
# FUNCTION     : optimise_MCU                                             */
# PURPOSE      : This function optimises the performance of the MPC5644A  */
#                SEQUENCE:                                                */
#                - Configure Minimal Flash Wait States and enable prefetch*/
#                - Configure Minimal SRAM Wait States                     */
#                - Enable Instruction Cache                               */
#                - Enable Branch Target Buffer                            */
#                - Configure Crossbar for optimal performance             */
#**************************************************************************/
optimise_MCU:

    mflr  r12               # Save Link Register to R12

    bl  cfg_FLASH           # Optimise Flash Bus Unit Interface Controls

# Doing this in C as it is Frequency dependent
# Flash is also, but an extra WS won't hurt at slower frequencies (at least for now)
    bl  cfg_SRAM            # Optimise RAM Wait States

    bl  cfg_ICACHE          # Enable Instruction Cache

    bl  cfg_BTB             # Enable Branch Target Buffer

    bl  cfg_XBAR            # Configure Crossbar

    mtlr    r12             # Restore Link Register
