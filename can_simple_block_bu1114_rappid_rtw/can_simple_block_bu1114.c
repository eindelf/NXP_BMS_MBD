 ...
 */
void can_simple_block_bu1114_SetEventsForThisBaseStep(boolean_T *eventFlags)
{
...
void Subsystem2_Reset(void)
{
  ...
  rtDWork.is_c1_can_simple_block_bu1114 = IN_NO_ACTIVE_CHILD_d;
  rtDWork.count_k = 0U;
  rtDWork.A_m = false;
}
...
void Subsystem2(void)
{
  ...
  if (rtDWork.is_active_c1_can_simple_block_b == 0U) {
    ...
    /* Transition: '<S28>:1' */
    rtDWork.count_k = 0U;
    rtDWork.is_c1_can_simple_block_bu1114 = IN_A_n;
    rtDWork.A_m = true;
  } else if (rtDWork.is_c1_can_simple_block_bu1114 == IN_A_n) {
    /* During 'A': '<S28>:3' */
    /* Transition: '<S28>:7' */
    rtDWork.A_m = false;
    rtDWork.is_c1_can_simple_block_bu1114 = IN_A1_a;
  } else {
    /* During 'A1': '<S28>:6' */
    /* Transition: '<S28>:8' */
    rtDWork.count_k++;
...
void Subsystem_Reset(rtDW_Subsystem *localDW)
{
  ...
  localDW->is_c19_can_simple_block_bu1114 = IN_NO_ACTIVE_CHILD;
  localDW->count = 0.0;
}
...
void Subsystem_i(rtDW_Subsystem *localDW, uint16_T rtd_CellV_1_104[104])
{
  ...
  if (localDW->is_active_c19_can_simple_block_ == 0U) {
    ...
    /* Transition: '<S20>:1' */
    localDW->count = 0.0;
    localDW->is_c19_can_simple_block_bu1114 = IN_A;

    /* Entry 'A': '<S20>:3' */
    localDW->count++;
  } else if (localDW->is_c19_can_simple_block_bu1114 == IN_A) {
    /* During 'A': '<S20>:3' */
    if (localDW->count >= 7.0) {
      /* Transition: '<S20>:7' */
      localDW->is_c19_can_simple_block_bu1114 = IN_A1;
...
void FunctionCallSubsystem_Reset(void)
{
  ...
  rtDWork.is_c7_can_simple_block_bu1114 = IN_NO_ACTIVE_CHILD_j;
  rtDWork.count_a = 0.0;
  rtDWork.A = false;
  rtDWork.is_active_c17_can_simple_block_ = 0U;
  rtDWork.is_c17_can_simple_block_bu1114 = IN_NO_ACTIVE_CHILD_j;
  rtDWork.count_o = 0.0;
  ...
  rtDWork.is_c9_can_simple_block_bu1114 = IN_NO_ACTIVE_CHILD_j;
  rtDWork.count_m = 0.0;

  /* SystemReset for Chart: '<S2>/Data collection chart' */
  rtDWork.is_active_c15_can_simple_block_ = 0U;
  rtDWork.is_c15_can_simple_block_bu1114 = IN_NO_ACTIVE_CHILD_j;
  rtDWork.count = 0.0;
  rtDWork.CMD32[0] = 0U;
  rtDWork.CMD32[1] = 0U;
  rtDWork.CMD32[2] = 0U;
...
void FunctionCallSubsystem(void)
{
  ...
  if (rtDWork.is_active_c7_can_simple_block_b == 0U) {
    ...
    /* Transition: '<S10>:1' */
    rtDWork.count_a = 0.0;
    rtDWork.is_c7_can_simple_block_bu1114 = IN_A_j;
    rtDWork.A = true;
  } else if (rtDWork.is_c7_can_simple_block_bu1114 == IN_A_j) {
    /* During 'A': '<S10>:3' */
    /* Transition: '<S10>:7' */
    rtDWork.A = false;
    rtDWork.is_c7_can_simple_block_bu1114 = IN_A1_c;
  } else {
    /* During 'A1': '<S10>:6' */
    /* Transition: '<S10>:8' */
    rtDWork.count_a++;
  ...
  if (rtDWork.is_active_c17_can_simple_block_ == 0U) {
    ...
    /* Entry Internal: Function-Call
       Subsystem/Chart1 */
    /* Transition: '<S11>:1' */
    rtDWork.is_c17_can_simple_block_bu1114 = IN_A_j;

    /* Entry 'A': '<S11>:3' */
    rtDWork.count_o = 0.0;
  } else if (rtDWork.is_c17_can_simple_block_bu1114 == IN_A_j) {
    /* During 'A': '<S11>:3' */
    if (rtDWork.count_o > 10.0) {
      ...
      rtDWork.is_c17_can_simple_block_bu1114 = IN_A1_c;
  ...
  if (rtDWork.is_active_c9_can_simple_block_b == 0U) {
    ...
    /* Entry Internal: Function-Call
       Subsystem/Chart2 */
    /* Transition: '<S12>:1' */
    rtDWork.is_c9_can_simple_block_bu1114 = IN_A_j;

    /* Entry 'A': '<S12>:3' */
    rtDWork.count_m = 0.0;
  } else if (rtDWork.is_c9_can_simple_block_bu1114 == IN_A_j) {
    /* During 'A': '<S12>:3' */
    if (rtDWork.count_m > 5.0) {
      /* Transition: '<S12>:7' */
      /* Event: '<S12>:12' */
      rtDWork.is_c9_can_simple_block_bu1114 = IN_A1_c;
  ...
  if (rtDWork.is_active_c15_can_simple_block_ == 0U) {
    ...
    /* Transition: '<S13>:1' */
    rtDWork.count = 0.0;
    rtDWork.is_c15_can_simple_block_bu1114 = IN_Vol_C123;
    ...
    switch (rtDWork.is_c15_can_simple_block_bu1114) {
     case IN_GPIO123:
      /* During 'GPIO123': '<S13>:12' */
      /* Transition: '<S13>:15' */
      /* Exit 'GPIO123': '<S13>:12' */
      /* Event: '<S13>:26' */
      rtDWork.is_c15_can_simple_block_bu1114 = IN_GPIO45_Vref;
     ...
     case IN_Vol_C123:
      ...
      /* Exit 'Vol_C123': '<S13>:3' */
      /* Event: '<S13>:25' */
      rtDWork.is_c15_can_simple_block_bu1114 = IN_Vol_C456;
     ...
     case IN_Vol_C456:
      ...
      /* Exit 'Vol_C456': '<S13>:6' */
      /* Event: '<S13>:28' */
      rtDWork.is_c15_can_simple_block_bu1114 = IN_Vol_C789;
     ...
     default:
      ...
      /* Event: '<S13>:29' */
      rtDWork.is_c15_can_simple_block_bu1114 = IN_GPIO123;
  ...
  SPITask_Outputs_wrapper( &rtDWork.SFunctionBuilder_o1[0] );
...
void can_simple_block_bu1114_step0(void) /* Sample time: [0.2s, 0.0s] */
{
...
void can_simple_block_bu1114_step1(void) /* Sample time: [1.0s, 0.0s] */
{
...
void can_simple_block_bu1114_step(int_T tid)
{
  switch (tid) {
   case 0 :
    can_simple_block_bu1114_step0();
    break;

   case 1 :
    can_simple_block_bu1114_step1();
    break;
...
void can_simple_block_bu1114_initialize(void)
{
...
void can_simple_block_bu1114_terminate(void)
{
