...
MAKEFILE        = can_simple_block_bu1114.mk
ALT_MATLAB_ROOT = C:\PROGRA~1\MATLAB\R2016b
MATLAB_ROOT     = C:\Program Files\MATLAB\R2016b
S_FUNCTIONS     = DMA_init_wrapper.c DMA.c SPIRead_wrapper.c BMU_Driver.c SPITask_wrapper.c
S_FUNCTIONS_OBJ = DMA_init_wrapper.obj DMA.obj SPIRead_wrapper.obj BMU_Driver.obj SPITask_wrapper.obj
S_FUNCTIONS_LIB = 
SOLVER          = 
NUMST           = 2
TID01EQ         = 0
...
MODELLIB                  = can_simple_block_bu1114lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	...
	-IC:\MCToolbox\rappid564xl\can_simple_block_bu1114_rappid_rtw \
	...
	-IC:\C\BMS\Ursidae\sfmInclude \
	-IC:\C\MCToolbox\rappid564xl\src\sfmInclude \
	-IC:\C\BMS\Ursidae\includes_MPC564xL \
	-IC:\C\BMS\Ursidae\include \
...
$(LIB_TEMP)/%.o: C:\C\BMS\Ursidae\sfmSrc/%.c
	@echo ### "C:\C\BMS\Ursidae\sfmSrc\$*.c"
	@$(COMPILE_TOOL) $(COMPILE_TOOL_OPTS) $(CFLAGS) -o $@ -c $<
$(PLIB_TEMP)/%.o: C:\C\BMS\Ursidae\sfmSrc/%.c
	@echo ### "C:\C\BMS\Ursidae\sfmSrc\$*.c"
	@$(COMPILE_TOOL) $(COMPILE_TOOL_OPTS) $(CFLAGS) -o $@ -c $<


$(LIB_TEMP)/%.o: C:\C\MCToolbox\rappid564xl\src\sfmSrc\BMU_Driver.c/%.c
	@echo ### "C:\C\MCToolbox\rappid564xl\src\sfmSrc\BMU_Driver.c\$*.c"
	@$(COMPILE_TOOL) $(COMPILE_TOOL_OPTS) $(CFLAGS) -o $@ -c $<
$(PLIB_TEMP)/%.o: C:\C\MCToolbox\rappid564xl\src\sfmSrc\BMU_Driver.c/%.c
	@echo ### "C:\C\MCToolbox\rappid564xl\src\sfmSrc\BMU_Driver.c\$*.c"
	@$(COMPILE_TOOL) $(COMPILE_TOOL_OPTS) $(CFLAGS) -o $@ -c $<
