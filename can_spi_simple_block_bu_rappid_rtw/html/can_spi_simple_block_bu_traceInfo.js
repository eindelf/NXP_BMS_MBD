function RTW_Sid2UrlHash() {
	...
	/* <Root>/CAN Config */
	this.urlHashMap["can_spi_simple_block_bu:2"] = "can_spi_simple_block_bu.c:130";
	/* <Root>/CAN Receive Data Trigger1 */
	this.urlHashMap["can_spi_simple_block_bu:3"] = "can_spi_simple_block_bu.c:143&can_spi_simple_block_bu.h:34,35,36,37";
	/* <Root>/CAN Transmit1 */
	this.urlHashMap["can_spi_simple_block_bu:4"] = "can_spi_simple_block_bu.c:91";
	/* <Root>/CAN_Receive_data1 */
	this.urlHashMap["can_spi_simple_block_bu:5"] = "can_spi_simple_block_bu.c:46,134";
	/* <Root>/Constant */
	this.urlHashMap["can_spi_simple_block_bu:6"] = "msg=rtwMsg_notTraceable&block=can_spi_simple_block_bu:6";
	/* <Root>/Constant1 */
	this.urlHashMap["can_spi_simple_block_bu:7"] = "can_spi_simple_block_bu.c:73";
	/* <Root>/Constant2 */
	this.urlHashMap["can_spi_simple_block_bu:8"] = "can_spi_simple_block_bu.c:74";
	/* <Root>/Constant3 */
	this.urlHashMap["can_spi_simple_block_bu:9"] = "can_spi_simple_block_bu.c:75";
	/* <Root>/Constant4 */
	this.urlHashMap["can_spi_simple_block_bu:10"] = "can_spi_simple_block_bu.c:76";
	/* <Root>/Constant5 */
	this.urlHashMap["can_spi_simple_block_bu:11"] = "can_spi_simple_block_bu.c:77";
	/* <Root>/Constant6 */
	this.urlHashMap["can_spi_simple_block_bu:12"] = "can_spi_simple_block_bu.c:78";
	/* <Root>/Constant7 */
	this.urlHashMap["can_spi_simple_block_bu:13"] = "can_spi_simple_block_bu.c:79";
	/* <Root>/Constant8 */
	this.urlHashMap["can_spi_simple_block_bu:14"] = "can_spi_simple_block_bu.c:80";
	/* <Root>/Constant9 */
	this.urlHashMap["can_spi_simple_block_bu:44"] = "msg=rtwMsg_notTraceable&block=can_spi_simple_block_bu:44";
	/* <Root>/DSPI Config */
	this.urlHashMap["can_spi_simple_block_bu:43"] = "msg=rtwMsg_notTraceable&block=can_spi_simple_block_bu:43";
	/* <Root>/DSPI Transmit */
	this.urlHashMap["can_spi_simple_block_bu:45"] = "msg=rtwMsg_notTraceable&block=can_spi_simple_block_bu:45";
	/* <Root>/Data Type Conversion4 */
	this.urlHashMap["can_spi_simple_block_bu:46"] = "msg=rtwMsg_notTraceable&block=can_spi_simple_block_bu:46";
	/* <Root>/Subsystem */
	this.urlHashMap["can_spi_simple_block_bu:16"] = "can_spi_simple_block_bu.c:29";
	/* <Root>/Out1 */
	this.urlHashMap["can_spi_simple_block_bu:29"] = "can_spi_simple_block_bu.h:44";
	/* <Root>/Out2 */
	this.urlHashMap["can_spi_simple_block_bu:30"] = "can_spi_simple_block_bu.h:45";
	/* <Root>/Out3 */
	this.urlHashMap["can_spi_simple_block_bu:31"] = "can_spi_simple_block_bu.h:46";
	/* <Root>/Out4 */
	this.urlHashMap["can_spi_simple_block_bu:32"] = "can_spi_simple_block_bu.h:47";
	/* <Root>/Out5 */
	this.urlHashMap["can_spi_simple_block_bu:33"] = "can_spi_simple_block_bu.c:69&can_spi_simple_block_bu.h:48";
	/* <S1>/In3 */
