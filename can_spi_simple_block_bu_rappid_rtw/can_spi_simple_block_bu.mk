...
MODULES         = adc0_config.c adc_564xl_library.c adc_init.c adc_trigger_init.c can0_buf4_7_isr.c flexcan_564xl_library.c intc_init.c intc_sw_vectable.c rappid_main.c rappid_utils.c siu_init.c sys_init.c sysclk_init.c 
...
ADD_INCLUDES = \
	...
	-IC:\MCToolbox\rappid564xl\can_spi_simple_block_bu_rappid_rtw \
